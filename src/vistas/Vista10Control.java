...
public class Vista10Control extends Vista00Generica {
    ...
    public Vista10Control() {
        super("La Cena de los Filosofos", "icono.png");
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(" La Cena de los Filosofos "));
        ...
        jLabel6.setText("Filosofo entra a comer");

        jLabel7.setText("Filosofo tiene un tenedor");

        jLabel8.setText("Filosofo esta comiendo");

        jLabel9.setText("Tenedor ocupado");

        jLabel10.setText("Tenedor libre");

        jLabel12.setText("Filosofo esta pensando");
        ...
        jLabel1.setText("Cuantas veces han comido:");
    ...
    private void jCheckBox_LogItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCheckBox_LogItemStateChanged
        if (jCheckBox_Log.isSelected()) {
            this.jTextArea_Log.append("\n\n Atencion:"
                    ...
                    + "\n con lo cual puede relentizar la ejecucion del programa, ya que todos tiene que usar"
                    + "\n este mismo recurso."
                    + "\n Utiliza el Log solo para fines de comprobacion.\n\n"
                    + "\n Pulsa en Iniciar\n\n\n");
        ...
        if (!jCheckBox_Log.isSelected()) {
            this.jTextArea_Log.append("\n\n Atencion:"
                    ...
                    + "\n forma de ejecutar el programa. El algoritmo se desarrolla integro, sin la escritura"
                    + "\n de todos los procesos."
                    + "\n Se debe usar el Log solo para fines de comprobacion.\n\n"
                    + "\n Pulsa en Iniciar");
            this.jTextArea_Log.setCaretPosition(this.jTextArea_Log.getDocument().getLength());
        }
